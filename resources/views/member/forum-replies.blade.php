            ...
            <div class="main--content-inner drop--shadow">
                ...
                <div class="forum--header pb--50">
                    ...
                    <div class="forum--subtitle ff--primary fs--14 text-darker">
                        <p>You have {{count($replies)}} topic(s)</p>
                    </div>
                    @endif
                </div>
                <!-- Forum Header End -->
                                ...
                                <li>
                                    ...
                                    <div class="topic--reply">
                                        <div class="header clearfix">
                                            <p class="date float--left">{{$rpy->created_at}}GMT in reply to <a href="{{$rpy->topic_slug}}">{{$rpy->topic_title}}</a></p>
                                            <p class="link float--right">
                                                <a href="#" onclick="event.preventDefault();
                                                    document.getElementById('delete-form{{ $rpy->reply_id }}').submit();"><i class="fa fa-trash-o fa-2x"></i></a>
                                                <form id="delete-form{{ $rpy->reply_id }}" action="{{ route('myreplies') }}/{{ $rpy->reply_id }}" method="POST" style="display: none;">
                                                    @csrf
                                                </form>
                                            </p>
                                        </div>
