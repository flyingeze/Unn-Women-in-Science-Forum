        ...
        <div class="main--content-inner drop--shadow">
            ...
            <div class="forum--header pb--50">
                <div class="forum--title">
                    <h3 class="h3 fw--500 text-default">Edit Category</h3>
                </div>
            </div>
            <!-- Forum Header End -->
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>
                                ...
                                <input type="text" name="cat_title" class="form-control form-md @error('cat_title') is-invalid @enderror" value="{{ $cat->cat_title }}" placeholder="Title" autofocus>
                            </label>
                            @error('cat_title')
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>
                                ...
                                <input type="text" name="cat_slug" class="form-control form-md @error('cat_slug') is-invalid @enderror" value="{{ $cat->cat_slug }}" placeholder="Slug">
                            </label>
                            @error('cat_slug')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
